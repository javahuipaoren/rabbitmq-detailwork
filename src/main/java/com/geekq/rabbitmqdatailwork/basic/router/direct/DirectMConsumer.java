 ...
 * @author 邱润泽 bullock
 */
public class DirectMConsumer extends DefaultConsumer {

    private static final Logger logger = LoggerFactory.getLogger(DirectMConsumer.class);
     ...
     */
    public DirectMConsumer(Channel channel) {
        super(channel);
